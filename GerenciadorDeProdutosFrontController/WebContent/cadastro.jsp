...
<body>
    ...
    <div class="login-dark">
        ...
        <input type="hidden" name="command" value="CadastrarProduto"> 
            ...
            <div class="form-group"><input class="form-control" type="text"  name="descricao" placeholder="Descrição"></div>
            <div class="form-group"><input class="form-control" type="number"  step="0.1" name="valor" placeholder="Preço Produto"></div>
